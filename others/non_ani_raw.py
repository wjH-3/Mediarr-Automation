...
def automate_webpage(url, media_type, tv_query=None):
    # URL info
    ...
    chrome_options.add_argument(f"profile-directory=Default")  # Specify profile directory (e.g., 'Profile 1' if you use a custom profile) (can be modified)
...
def main():
    ...
    if imdb_id:
        ...
        automate_webpage(url, media_type, tv_query)
