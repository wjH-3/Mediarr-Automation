...
def get_url(anime_id, anime_status, title_romaji):
    ...
    subsplease_base_url = "https://nyaa.si/user/subsplease?f=0&c=1_2&q={}+1080p&o=desc&p=1"
    seadex_base_url = "https://releases.moe/"
    subsplease_batch_base_url = "https://nyaa.si/user/subsplease?f=0&c=1_2&q={}+1080p+batch&o=desc&p=1"
                ...
                for item in data['items'][0]['trs']:
                    for tr in data['items'][0]['expand']['trs']:
                        if tr['id'] == item and tr['tracker'] == "Nyaa" and tr['releaseGroup'] == list(release_groups)[choice - 1]:
                            original_url = tr['url']
                            new_url = original_url.replace(".si/", ".si/")
                            return f"{new_url}"
